...
def plot(dataset: str, classifierResults: list[ClassifierResults], performanceType: str,
    ...
    # if (dataset != "gradual_drift_synth_attr2_speed0.2_len20000" and dataset != "gradual_drift_synth_attr2_speed0.5_len20000"):
    #     return
    ...
    for classifier in classifierResults:
        ...
        if mode is None or mode == "sample":
            ...
            axes.set_title(r"Dokładność klasyfikacji w oknie 500 próbek, " + dataset)
