...
public abstract class BaseProcessFunctionClassifyAndTrain<C extends BaseClassifierClassifyAndTrain> extends BaseProcessFunction<C> {
    ...
    protected Tuple4<String, Integer, ArrayList<Tuple2<String, Object>>, C> processExample(Example example, C classifier) {
        Tuple3<String, Integer, ArrayList<Tuple2<String, Object>>> classifyResults = classifier.classify(example);
        ArrayList<Tuple2<String, Object>> trainingResults = classifier.train(example, classifyResults.f1, classifyResults.f2);
