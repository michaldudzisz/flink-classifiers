...
from latex_table_atnn_lambda import atnn_lambda_accuracy_comparison_table
from latex_table_atnn_lr import atnn_lr_accuracy_comparison_table
from latex_table_atnn_size import atnn_size_accuracy_comparison_table
from latex_table_atnn_size_time import atnn_size_time_comparison_table
...
if __name__ == "__main__":
    ...
    print_latex_tables_acc = True
    if print_latex_tables_acc:
        acc_latex_table = atnn_lambda_accuracy_comparison_table(summary)
        with open("misc/plotter/atnn_lambda_table.tex", "w") as f:
            f.write(acc_latex_table)

        acc_latex_table = atnn_lr_accuracy_comparison_table(summary)
        with open("misc/plotter/atnn_lr_table.tex", "w") as f:
            f.write(acc_latex_table)

        acc_latex_table = atnn_size_accuracy_comparison_table(summary)
        with open("misc/plotter/atnn_size_acc_table.tex", "w") as f:
            f.write(acc_latex_table)

        acc_latex_table = atnn_size_time_comparison_table(summary)
        with open("misc/plotter/atnn_size_time_table.tex", "w") as f:
            f.write(acc_latex_table)
