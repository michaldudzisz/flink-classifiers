...
public class Node {
    ...
    public Node copy(Node parent, int branchType) {
        ...
        copied.hW = this.hW.copy();
        copied.hb = this.hb.copy();
        copied.cW = this.cW.copy();
        copied.cb = this.cb.copy();
        copied.hideInput = this.hideInput.copy();
...
//        copied.dev_hInput = copied.dev_hInput.copy();
        ...
        copied.squareGrad_hb = this.squareGrad_hb.copy();
        copied.Fisher_hW = this.Fisher_hW.copy();
        copied.Fisher_hb = this.Fisher_hb.copy();
        copied.alertSquareGrad_hW = this.alertSquareGrad_hW.copy();
        copied.alertSquareGrad_hb = this.alertSquareGrad_hb.copy();
        copied.alertFisher_hW = this.alertFisher_hW.copy();
        copied.alertFisher_hb = this.alertFisher_hb.copy();
        copied.lastConcept_hW = this.lastConcept_hW.copy();
        copied.lastConcept_hb = this.lastConcept_hb.copy();
        return copied;
    }
}
